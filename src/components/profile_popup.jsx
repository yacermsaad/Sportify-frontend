            ...
            <div className={`flex justify-center animate__animated animate__zoomIn`}>
                <div className="min-[550px]:w-[490px]  h-[350px] min-[870px]:rounded-r-lg max-[870px]:rounded-lg bg-white">
                    ...
                    <div class="flex items-center justify-center  ">
                        <label for="dropzone-file" class="flex flex-col items-center justify-center w-[300px] h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800  hover:bg-gray-100  ">
                            ...
                            <input id="dropzone-file" type="file" class="hidden" accept="image/png, image/jpeg" onChange={(e)=>{setimage(e.target.files[0])}}/>
                        </label>
                    </div> 

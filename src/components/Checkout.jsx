        ...
        <div className="flex flex-col xl:flex-row justify-center xl:justify-between space-y-6 xl:space-y-0 xl:space-x-6 w-full">
          <div className="xl:w-3/5 flex flex-col sm:flex-row xl:flex-col justify-center items-center bg-gray-100 dark:bg-gray-800 py-7 sm:py-0 xl:py-10 px-10 xl:w-full">
            <div className="flex flex-col justify-start items-start w-full space-y-4">
              <p className="text-xl md:text-4xl leading-normal text-gray-800 dark:text-gray-50" >Price of <span style={{color:"green"}}>Consultation :</span></p>
              <p className="text-base font-semibold leading-none text-gray-600 dark:text-white" style={{fontSize:"34px"}}>520.00 Mad</p>
            </div>
            <div className="mt-6 sm:mt-0 xl:my-10 xl:px-20 w-52 sm:w-96 xl:w-auto">
              <img src="./img/consult.svg" alt="headphones" style={{width:"800px"}} />
            </div>
          </div>
          ...
          <div className="p-8 bg-gray-100 dark:bg-gray-800 flex flex-col lg:w-full xl:w-3/5">
            ...
            <div className="mt-2 flex-col">
              <div>
                <input className="border rounded-tl rounded-tr border-gray-300 p-4 w-full text-base leading-4 placeholder-gray-600 text-gray-600" type="text" name="" id="" placeholder="0000 1234 6549 15151" />
              </div>
              <div className="flex-row flex">
                <input className="border rounded-bl border-gray-300 p-4 w-full text-base leading-4 placeholder-gray-600 text-gray-600" type="text" name="" id="" placeholder="MM/YY" />
                <input className="border rounded-br border-gray-300 p-4 w-full text-base leading-4 placeholder-gray-600 text-gray-600" type="text" name="" id="" placeholder="CVC" />
              </div>
            </div>
            ...
            <div className="mt-2 flex-col">
              <div>
                <input className="border rounded border-gray-300 p-4 w-full text-base leading-4 placeholder-gray-600 text-gray-600" type="text" name="" id="" placeholder="Name on card" />
              </div>
            </div>
            ...
            <div className="mt-2 flex-col">
              <div className="relative">
                <button
                  ...
                  <svg
                    onClick={toggleDropdown}
                    className={`cursor-pointer absolute top-4 right-4 ${dropdownOpen ? 'hidden' : ''}`}
                    width="16"
                    height="16"
                    viewBox="0 0 16 16"
                    fill="none"
                  ...
                  <svg
                    onClick={toggleDropdown}
                    className={`cursor-pointer transform rotate-180 absolute top-4 right-4 ${dropdownOpen ? '' : 'hidden'}`}
                    width="16"
                    height="16"
                    viewBox="0 0 16 16"
                    fill="none"
                  ...
                  <div className={`mt-1 absolute z-10 w-full flex bg-gray-50 justify-start flex-col text-gray-600 ${dropdownOpen ? '' : 'hidden'}`}>
                    <div onClick={() => handleCountryChange('China')} className="cursor-pointer hover:bg-gray-800 hover:text-white px-4 py-2">
                      China
                    </div>
                    <div onClick={() => handleCountryChange('Russia')} className="cursor-pointer hover:bg-gray-800 hover:text-white px-4 py-2">
                      Russia
                    </div>
                    <div onClick={() => handleCountryChange('UK')} className="cursor-pointer hover:bg-gray-800 hover:text-white px-4 py-2">
                      UK
                    </div>
                  </div>
                </div>
              ...
              <Link to="/consultation">
                <button className="mt-8 border border-transparent hover:border-gray-300 dark:bg-white dark:hover:bg-gray-900 dark:text-gray-900 dark:hover:text-white dark:border-transparent bg-gray-900 hover:bg-white text-white hover:text-gray-900 flex justify-center items-center py-4 rounded w-full">
                  <div>
                    <p className="text-base leading-4">Proceed to Consultation</p>
                  </div>
                </button>
              </Link>
            </div>

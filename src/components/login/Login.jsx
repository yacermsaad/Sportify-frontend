    ...
    const handleRegistration = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                // Optionally, redirect the user to a new page or show a success message
                // Clear form fields
                setName('');
                setEmail('');
                setPass('');
                    ...
                    <form className="" onSubmit={handleRegistration}>
                        ...
                        <div className="w-full px-8 pt-5 ">
                            ...
                            <div className={'mb-1 mt-2'}>
                                ...
                                <input className="text-sm bg-gray-200 appearance-none rounded w-full py-2 px-3 text-gray-700 mb-1 leading-tight focus:outline-none focus:shadow-outline h-10" id="password" type="password" placeholder={t('v_m_p')} onChange={(e) => setPass(e.target.value)} value={password} />

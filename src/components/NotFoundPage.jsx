...
const NotFoundPage = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-indigo-500 bg-fixed bg-cover bg-bottom error-bg" style={containerStyle}>
      <div className="container">
        <div className="row">
          <div className="col-sm-8 offset-sm-2 text-gray-50 text-center -mt-52">
            <div className="relative">
              <h1 className="relative text-9xl tracking-tighter-less font-sans font-bold" style={textShadowStyle}>
                <span style={letterSpacingStyle}>4</span><span style={letterSpacingStyle}>0</span><span style={letterSpacingStyle}>4</span>
              </h1>
